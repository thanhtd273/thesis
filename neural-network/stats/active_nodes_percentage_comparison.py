...
def main():
    ...
    for num_nodes in num_nodes_list:
        benign_dataset_path = (
            CONFIG.OUTPUT_DIRECTORY + "pre_process/Output/group_0/benign_data/benign_data_2021-01-02 00:00:00_2021-02-01 23:59:58_time_step_" + str(time_step) + "_num_ids_" + str(num_nodes) + ".csv"
        )
